...
Tuli internal server error ja en päässyt eteenpäin joten googlasin. Selvisi, että jostain syystä tässä tehtävässä '--' kommentointi merkki et toimi ja se pitää korvata '#' merkillä. Lisäksi toinen arvo pitää muuttaa 'NULL' arvoksi. (testasin kirjoittaa alla olevaa komentoa suoraan selaimeen eikä se toiminut, en tiedä miksi. Muuttamalla komento zapissa GET pyyntöön se toimi)
...
## Lähteet
1  https://terokarvinen.com/2023/eettinen-hakkerointi-2023/<br>2  https://terokarvinen.com/2016/03/05/postgresql-install-and-one-table-database-sql-crud-tutorial-for-ubuntu/<br>3  https://portswigger.net/web-security/sql-injection<br>https://owasp.org/www-project-top-ten/2017/A1_2017-Injection<br>4  https://dba.stackexchange.com/questions/54242/cannot-start-psql-with-user-postgres-could-not-change-directory-to-home-user<br>5    https://portswigger.net/web-security/sql-injection/cheat-sheet
